<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="账号" align="center" width="80">
        <template slot-scope="{row}">
      ...
      <el-table-column label="用户地址" align="center" width="150">
        <template slot-scope="{row}">
          <span>{{ row.address }}</span>
        </template>
      </el-table-column>
      <el-table-column label="账户是否启用" align="center" width="70">
        <template slot-scope="{row}">
          <!--          <span>{{ row.enabled}}</span>-->
          <span v-if="row.enabled" style="color: green">已激活</span>
          <span v-else style="color: red">未激活</span>
        </template>
      </el-table-column>
      <el-table-column label="头像" align="center" width="80">
        <template slot-scope="{row}">
          <el-avatar :size="50" :src="row.userFace" />
        </template>
      </el-table-column>
      ...
      <el-table-column label="年龄" align="center" width="50">
        <template slot-scope="{row}">
          <span>{{ row.age }}</span>
        </template>
      </el-table-column>
      <el-table-column label="创建时间" width="160" align="center">
        <template slot-scope="{row}">
          <span>{{ handleDateFormat(row.gmtCreate) }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="备注" align="center" width="50">
        <template slot-scope="{row}">
...
import { pageQuery } from '@/api/admin'
